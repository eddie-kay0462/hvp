                ...
                <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
                      ...
                      <div className="space-y-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            When a Customer pays for a service through Paystack, the entire payment is first received into Hustle Village's designated company account. This ensures a centralised and secure payment process. Your money is held securely while the service is being delivered, which protects both parties. The Customer acknowledges that Hustlers do not receive funds directly from Customers and that all disbursements are handled manually by Hustle Village. After the service is delivered, or after certain conditions are met, Hustle Village releases funds to the Hustler. This is a structured and transparent process; it is not a licensed third-party funds custody service.
                          </p>
